<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="danhmucsp.aspx.cs" Inherits="DoVanQuan_2019600274.danhmucsp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" runat="server">
    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource2">
        <ItemTemplate>
            <asp:Label ID="label" runat="server" ForeColor="Blue" Font-Bold="true" Font-Size="20" Text='<%# Eval("TenDanhmuc") %>' />
        </ItemTemplate>
    </asp:Repeater>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:QLSanpham2ConnectionString %>" SelectCommand="SELECT * FROM [Danhmuc] where MaDanhmuc = @MaDanhmuc">
        <SelectParameters>
...
<br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QLSanpham2ConnectionString %>" 
            DeleteCommand="DELETE FROM [Trangsuc] WHERE [MaTs] = @MaTs" 
            InsertCommand="INSERT INTO [Trangsuc] ([TenTs], [Anh], [Mota], [Soluong], [Giatien], [MaDanhmuc]) VALUES (@TenTs, @Anh, @Mota, @Soluong, @Giatien, @MaDanhmuc)" 
            SelectCommand="Select MaTs, TenTs, Anh, Trangsuc.Mota, Soluong, Giatien, Danhmuc.MaDanhmuc, TenDanhmuc, Danhmuc.Mota
from Trangsuc inner join Danhmuc on Trangsuc.MaDanhmuc = Danhmuc.MaDanhmuc Where Danhmuc.MaDanhmuc = @MaDanhmuc" 
            UpdateCommand="UPDATE [Trangsuc] SET [TenTs] = @TenTs, [Anh] = @Anh, [Mota] = @Mota, [Soluong] = @Soluong, [Giatien] = @Giatien, [MaDanhmuc] = @MaDanhmuc WHERE [MaTs] = @MaTs">
            <SelectParameters>
                <asp:QueryStringParameter Name="MaDanhmuc" Type="Int32" QueryStringField="MaDanhmuc" />
            </SelectParameters>
            <DeleteParameters>
